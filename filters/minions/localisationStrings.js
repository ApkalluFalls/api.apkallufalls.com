module.exports = {
  ...
  purchase: {
    ...
    fr: 'Acheté pour {img2} {i0} {i1} chez {3} {4} à {img5} {6} (x: {7}, y: {8}).'
  },
  eventQuestPurchase: {
  ...
  preOrder: {
    en: '{i0} {1} and register the promotional code on or before {2}.',
    de: '{i0} {1} und registriere den Aktionscode am oder vor {2}.',
    fr: '{i0} {1} et enregistrer le code promotionnel le, ou avant le {2}.'
  },
  ...
  raid: {
    ...
    fr: 'Récompense aléatoire dans un coffre dans le raid de niveau {0} {img1} \'{i2}\' (x: {3}, y: {4}).'
  },
  trial: {
  ...
  fateUnknown: {
    en: 'Achieve gold rating in the level {0} FATE {img1} \'{i2}\' in {img3} {4}.',
    de: 'Erziele eine Gold-Bewertung im level {0} FATE {img1} \'{i2}\' in {img3} {4}.',
    fr: 'Atteindre la récompense or sur l\'ALEA niveau {0} {img1} \'{i2}\' dans {img3} {4}.'
  },
  gilAfterFate: {
    ...
    fr: 'Acheté pour {img2} {i0} {i1} chez {3} à {img4} {5} (x: {6}, y: {7}) après avoir complété l\'ALEA niveau {8} {img9} \'{i10}\' (x: {11}, y: {12}).'
  },
  itemAccursedHoard: {
  ...
  fishing: {
    en: 'Gathered by a {i0} at {1} in {img2} {i3} (x: {4}, y: {5}) using {6} as bait (level {7}).',
    de: 'Gesammelt von einem {i0} bei {1} in {img2} {i3} (x: {4}, y: {5})  {6} als Köder benutzend (level {7}).',
    fr: 'Récolté par un {i0} à {1} dans {img2} {i3} (x: {4}, y: {5}) avec un appât {6} (niveau {7}).'
  },
  fishingDesynth: {
    en: 'Desynthesise {i0} as a {i1}, gathered by a {i2} at {3} in {img4} {i5} (x: {6}, y: {7}) mooching {8} (level {9}).',
    de: 'Verwerte {i0} als {i1}, gesammelt von einem {i2} bei {3} in {img4} {i5} (x: {6}, y: {7}) Naturköder benutzend {8} (level {9}).',
    fr: 'Recyclé sur un {i0} par un {i1}, pêché par un {i2} à {3} dans {img4} {i5} (x: {6}, y: {7}) pêché au vif avec un {8} (niveau {9}).'
  },
  fishingDoubleMooch: {
    en: 'Double-mooched by a {i0} at {1} in {img2} {i3} (x: {4}, y: {5}) using {6} as bait (level {7}) to catch a {8}, mooched to catch a {9}.',
    de: 'Doppelt Naturköder verwenden von {i0} bei {1} in {img2} {i3} (x: {4}, y: {5}) {6} als Köder benutzend (level {7}) um einen {8} zu fangen, als Naturköder benutz um einen {9} zu fangen.',
    fr: 'Double pêche au vif par un {i0} à {1} dans {img2} {i3} (x: {4}, y: {5}) avec un appât {6} (niveau {7}) pour attraper un {8}, puis pêcher au vif un {9}.'
  },
  fishingSpearfishing: {
    en: 'Spearfished from a {0} node by a {i1} using a {2} at {3} in {img4} {i5} (x: {6}, y: {7}) after catching {8} {9} (level {10}) with a {11}.',
    de: 'Speergefischt von einer {0} Sammelstelle bei {i1} {2} benutzend bei {3} in {img4} {i5} (x: {6}, y: {7}) nach Fangen von {8} {9} (level {10}) mit einem {11}.',
    fr: 'Pêché au harpon dans un {0} par un {i1} avec une {2} à {3} dans {img4} {i5} (x: {6}, y: {7}) après avoir pêché {8} {9} (niveau {10}) avec une {11}.'
  },
  achievementCertificate: {
    en: 'Purchase for {i0} {i1} {img2} from {3} at {4} in {img5} {6} (x: {7}, y: {8}).',
    de: 'Erhältlich für {i0} {i1} {img2} von {3} bei {4} in {img5} {6} (x: {7}, y: {8}).',
    fr: 'Acheté pour {i0} {i1} {img2} chez {3} à {4} dans {img5} {6} (x: {7}, y: {8}).'
  },
  veteranReward: {
    en: 'Received as mail from a {i0} for subscribing for {1} days.',
    de: 'Von einer Nachricht von {0} für Abonnieren von {1} Tagen.',
    fr: '{i0} reçue par courrier pour avoir souscrit à {1} jours d\'abonnement.'
  },
  gather: {
    en: 'Gathered by a level {0} {i1} at an unspoiled node{2} in {img3} {4} (x: {5}, y: {6}) at {7} (slot {8}).',
    de: 'Von einem level {0} {i1} gesammelt bei einer unberührten Sammelstelle{2} in {img3} {4} (x: {5}, y: {6}) at {7} (slot {8}).',
    fr: 'Récolté par un {i1} niveau {0} sur un filon intacte{2} dans {img3} {4} (x: {5}, y: {6}) à {7} (slot {8}).'
  },
  mogStation: {
  ...
  beastTribe: {
    en: 'Achieve {0} reputation with the {i1} Beast Tribe, then purchase for {img4} {i2} {i3} from {5} {6} in {img7} {8} (x: {9}, y: {10}).',
    de: 'Erreiche Verbundenheit {0} mit dem {i1} Stamm, dann erwirb es für {img4} {i2} {i3} von {5} {6} in {img7} {8} (x: {9}, y: {10}).',
    fr: 'Après avoir atteint la réputation {0} avec la tribu {i1}, acheté pour {img4} {i2} {i3} chez {5} {6} à {img7} {8} (x: {9}, y: {10}).'
  },
  squareEnixStore: {
  ...
  retainerVentureQuick: {
    en: 'Randomly awarded from a {img0} {i1} retainer venture.',
    de: 'Zufälig erhalten von einer {img0} {i1} Unternehmung',
    fr: 'Récompense aléatoire de la tâche de servant {img0} {i1}.'
  },
  gardening: {
    en: 'Cultivate {img0} {i1}.',
    de: 'Baue {img0} {i1} an.',
    fr: 'Cultiver {img0} {i1}.'
  },
  wondrousTails: {
    en: 'Randomly awarded when completing {0} lines of {img1} {i2}.',
    de: 'Zufällig vergeben beim Vervollständigen von {0} Linien in {img1} {i2}.',
    fr: 'Récompense aléatoire en complétant {0} lignes du {img1} {i2}.'
  },
  fanFestival: {
  ...
  fanFestivalStream: {
    en: 'Purchase the online live stream of the {y0} fan festival in {1}.',
    de: 'Erhältlich den online Live-Stream des {y0} Fanfests in {1}',
    fr: 'Acheter en ligne le live stream du fan festival {y0} à {1}.'
  },
