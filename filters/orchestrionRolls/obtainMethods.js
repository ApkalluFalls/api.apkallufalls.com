 ...
 */
module.exports = (orchestrionRoll, achievementsIn) => {
  achievements = achievementsIn;
  switch (+orchestrionRoll.id) {
    default:
      // console.log("Unknown method for orchestrion roll " + orchestrionRoll.id);
      return o(
        'orchestrion',
        [orchestrionRoll.description],
        expansions.Unknown,
        true,
        false
      );
