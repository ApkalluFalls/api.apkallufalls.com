module.exports = {
  ...
  purchase: { en: 'Purchase for {i0} {i1} {img2} from {3} {4} in {5} (x: {6}, y: {7}).' },
  ...
  fate: { en: 'Achieve gold rating in the level {0} FATE {img1} \'{i2}\' in {3} (x: {4}, y: {5}).' },
  gilAfterFate: { en: 'Purchase for {i0} {i1} {2} from {3} in {4} (x: {5}, y: {6}) after completing the level {7} FATE {img8} \'{i9}\' (x: {10}, y: {11}).' },
  ...
  achievementCertificate: { en: 'Purchase for {i0} {i1} {img2} from {3} at {4} in {5} (x: {6}, y: {7}).' },
